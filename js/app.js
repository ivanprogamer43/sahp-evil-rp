$(function(){
    ...
    $('#bsup_adm').click(function(){
        ...
        if($('#estado_opos').text() == 'open'){
            $('#formulario_adm').show();
            $('#estado_opos').html(`<i>Pruebas de Acceso: <span style="color:green">ABIERTAS</span><span style = "color: #003b5a"></br> Instancia de acceso: 17/6/2022 - 6/7/2022 hasta las 18:00</br> Prueba Teórica: 8/7/2022 a las 18:00 en la comisaria de Mission Row</br> Pruebas Prácticas: 9/7/2022 a las 17:00 en la comisaria de Mission Row</span></i>`)
